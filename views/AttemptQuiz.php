...
<html>
	...
	<body>
        ...
        <?php
            ...
            $sql1="SELECT totalques from questionindex where quizname='".$_SESSION['quiz_name']."'";
            ...
            {
                echo '<h4 style="color:white" class="f"><center>Your Respnse has been Submitted successfully!</center></h4>';
            }
        ?>
    </body>
=======
        ...
        <?php
            ...
            else
            {
                echo '<h4 style="color:white" class="f"><center>Your Respnse has been Submitted successfully!</center></h4><br>
						<h5 style="color:white" class="f"><center>You answered '.$_SESSION['marks'].' out of '.$totalques.' correctly!';
            }
        ?>
    </body>
